...
import { createInventorySchema, stockTransactionSchema, } from "../validators/inventoryValidator.js";
export const createInventory = async (req, res) => {
    try {
        ...
        const { itemId, locationId, batchId, physicalQuantity, reservedQuantity, } = result.data;
...
export const createStockTransaction = async (req, res) => {
    try {
        ...
        const { inventoryId, type, quantity, transactionKey, } = result.data;
        ...
        return res.status(201).json({
            ...
            inventory: {
                ...
                availableQuantity: resultTransaction.updatedInventory.physicalQuantity -
