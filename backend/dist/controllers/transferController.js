...
export const createTransfer = async (req, res) => {
    try {
        ...
        const availableQuantity = sourceInventories.reduce((total, inventory) => total + inventory.physicalQuantity - inventory.reservedQuantity, 0);
    ...
    try {
        ...
        if (data.status === "DISPATCHED") {
            ...
            const updatedTransfer = await prisma.$transaction(async (tx) => {
                ...
                const availableQuantity = inventories.reduce((total, inventory) => total + inventory.physicalQuantity - inventory.reservedQuantity, 0);
